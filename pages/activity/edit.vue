  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,type,image,description,discount,fullAmount,reduceAmount,couponValue,couponMinAmount,startTime,endTime,sort,status").get().then((res) => {
